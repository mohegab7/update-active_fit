...
import 'package:active_fit/features/onboarding/presentation/widgets/onboarding_intro_page_body.dart';
  ...
  List<PageViewModel> _getPageViewModels() => <PageViewModel>[
        ...
        PageViewModel(
            ...
            bodyWidget: OnboardingOverviewPageBody(
              ...
              totalKcalCalculated: _onboardingBloc.getOverviewCalorieGoal(),
            ),
            footer: HighlightButton(
              buttonLabel: S.of(context).buttonStartLabel,
              onButtonPressed: () {

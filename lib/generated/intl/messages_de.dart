...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addtoDiaryLabel": MessageLookupByLibrary.simpleMessage(
    ...
    "bmiInformation": MessageLookupByLibrary.simpleMessage(
      "Der Body-Mass-Index (BMI) ist ein Maß für Körperfett basierend auf Größe und Gewicht.",
    ),
    ...
    "galleryLabel": MessageLookupByLibrary.simpleMessage("Galerie"),
    ...
    "healthRiskLabel": MessageLookupByLibrary.simpleMessage(
      "Gesundheitsrisiko:",
    ),
    ...
    "normalWeightTips": MessageLookupByLibrary.simpleMessage(
      "Erhalten Sie Ihren gesunden Lebensstil mit einer ausgewogenen Ernährung und regelmäßiger körperlicher Aktivität.",
    ),
    ...
    "obesityClassIIITips": MessageLookupByLibrary.simpleMessage(
      "Es ist ratsam, einen Arzt für persönliche Beratung zu konsultieren.",
    ),
    "obesityClassIITips": MessageLookupByLibrary.simpleMessage(
      "Eine gesündere Ernährung und mehr Bewegung können helfen, Ihren BMI zu verbessern.",
    ),
    "obesityClassITips": MessageLookupByLibrary.simpleMessage(
      "Erwägen Sie, weniger verarbeitete Lebensmittel zu essen und mehr Sport zu treiben.",
    ),
    ...
    "orLabel": MessageLookupByLibrary.simpleMessage("ODER"),
    ...
    "preObesityTips": MessageLookupByLibrary.simpleMessage(
      "Versuchen Sie, mehr körperliche Aktivitäten einzubauen und Ihre Kalorienzufuhr zu überwachen.",
    ),
    ...
    "registerLabel": MessageLookupByLibrary.simpleMessage("Registrieren"),
    ...
    "scanYourFoodDescription": MessageLookupByLibrary.simpleMessage(
      "Machen Sie ein Foto von Ihrem Essen oder wählen Sie aus der Galerie, um sofort Nährwertinformationen zu erhalten",
    ),
    "scanYourFoodLabel": MessageLookupByLibrary.simpleMessage(
      "Scannen Sie Ihr Essen",
    ),
    ...
    "underWeightTips": MessageLookupByLibrary.simpleMessage(
      "Erwägen Sie, Ihre Kalorienzufuhr mit nahrhaften Lebensmitteln zu erhöhen. Krafttraining kann beim Aufbau von Muskelmasse helfen.",
    ),

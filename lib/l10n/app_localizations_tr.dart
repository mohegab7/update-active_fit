...
class STr extends S {
  ...
  @override
  String get appDescription => 'active_fit, gizliliğinize saygı duyan ücretsiz ve açık kaynaklı bir kalori ve besin takipçisidir.';
  ...
  @override
  String get onboardingWeightExampleHintLbs => 'örn. 132';

  @override
  String get onboardingHeightExampleHintCm => 'örn. 170';

  @override
  String get onboardingHeightExampleHintFt => 'örn. 5.8';
  ...
  @override
  String get settingsImperialLabel => 'İmparatorluk (lbs, ft, oz)';
  ...
  @override
  String get disclaimerText => 'active_fit tıbbi bir uygulama değildir. Sağlanan tüm veriler doğrulanmamıştır ve dikkatle kullanılmalıdır. Lütfen sağlıklı bir yaşam tarzı sürdürün ve herhangi bir sorununuz varsa bir uzmana danışın. Hastalık, hamilelik veya emzirme döneminde kullanılması önerilmez.\n\n\nUygulama hala geliştirme aşamasındadır. Hatalar, buglar ve çökmeler meydana gelebilir.';
  ...
  @override
  String get dailyKcalAdjustmentLabel => 'Günlük Kalori Ayarlaması:';
  ...
  @override
  String get ozUnit => 'ons';

  @override
  String get flOzUnit => 'sıvı ons';
  ...
  @override
  String get emailError => 'Lütfen e-postanızı girin';

  @override
  String get emailInvalidError => 'Lütfen geçerli bir e-posta adresi girin';
  ...
  @override
  String get passwordError => 'Şifre en az 6 karakter olmalıdır';
  ...
  @override
  String get passwordEmptyError => 'Lütfen şifrenizi girin';

  @override
  String get alreadyHaveAccount => 'Zaten hesabınız var mı? Giriş Yap';

  @override
  String get registerError => 'Geçersiz e-posta veya şifre';

  @override
  String get foodScannerLabel => 'Yiyecek Tarayıcı';
  ...
  @override
  String get scanYourFoodLabel => 'Yemeğinizi Tara';

  @override
  String get scanYourFoodDescription => 'Anında besin değerleri bilgisi almak için yemeğinizin fotoğrafını çekin veya galeriden seçin';

  @override
  String get scanningLabel => 'Görüntü analiz ediliyor...';

  @override
  String get recognizedFoodLabel => 'Tanınan Yiyecek:';

  @override
  String get nutritionFactsLabel => 'Besin Değerleri';

  @override
  String get addtoDiaryLabel => 'Günlüğe Ekle';
  ...
  @override
  String get underWeightTips => 'Besleyici gıdalarla kalori alımınızı artırmayı düşünün. Kuvvet antrenmanları kas kütlesi oluşturmaya yardımcı olabilir.';

  @override
  String get normalWeightTips => 'Dengeli bir beslenme ve düzenli fiziksel aktivite ile sağlıklı yaşam tarzınızı sürdürün.';

  @override
  String get preObesityTips => 'Daha fazla fiziksel aktivite eklemeyi ve kalori alımınızı izlemeyi deneyin.';

  @override
  String get obesityClassITips => 'İşlenmiş gıdaları azaltmayı ve fiziksel aktiviteyi artırmayı düşünün.';

  @override
  String get obesityClassIITips => 'Daha sağlıklı bir diyet ve artan egzersiz BMI\'nizi iyileştirmeye yardımcı olabilir.';

  @override
  String get obesityClassIIITips => 'Kişiselleştirilmiş tavsiye için bir sağlık uzmanına danışmanız önerilir.';

  @override
  String get healthRiskLabel => 'Sağlık Riski:';

  @override
  String get bmiInformation => 'Vücut Kitle İndeksi (BMI), boy ve kiloya dayalı vücut yağ ölçüsüdür.';
